      ...
      <header className="section-hero bg-no-repeat">
        <div className="section-hero-center md:container section lg:py-60 py-28 lg:px-10 ">
          <div className="my-info-hero">
            <h4 className="hero-sub-heading font-bold 2xl:text-2xl text-xl mb-2">Looking for a Designer</h4>
            <h1 className="hero-heading font-bold text-6xl 2xl:text-7xl mb-3">I am a Frank Jack.</h1>
            <p className="hero-desc xl:w-4/5 lg:text-gray-500 mb-3">
